...
<div class="container-fluid">
    <div class="row">
            <div class="col-12">
                <h1> <b> Solicitudes de Registro </b> </h1>
                <div class="card">
                    <div class="card-header bg-primary ">
                        <h3 class="card-title"> <b>Lista de Solicitud de Registro</b></h3>
                        <br>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="" class=" float-right">
                            <div class="form-row">
                                <div class="col my-1">
                                    <input type="text"  class="form-control" name="buscarpor" placeholder="Buscar por Nombre" value=""  >
                                </div>
